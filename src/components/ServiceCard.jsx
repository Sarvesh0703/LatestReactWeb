...
const ServiceCard = ({service, index}) => {
  ...
  return (
    ...
    dark:border-gray-700 text-gray-700 shadow-2xl shadow-gray-100 dark:shadow-white/10 dark:text-white'
    onMouseEnter={()=>setVisible(true)} onMouseLeave={()=>setVisible(false)} ref={divRef} onMouseMove={handleMouseMove}>
        ...
        duration-500 mix-blend-lighten ${visible ? 'opacity-70' : 'opacity-0'}`} style={{left: position.x - 150, top: position.y - 150}} />
            ...
            transition-all rounded-[10px] bg-white dark:bg-gray-900 z-10 relative'>
                ...
                <div className='bg-gray-100 dark:bg-gray-700 rounded-full'>
                    <img src={service.icon} alt="Service Icon" className='max-w-24 bg-white
